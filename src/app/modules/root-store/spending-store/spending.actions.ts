...
export const addSpendingItemSuccess = createAction('[Spending] Add Spending Item Success');
...
export const deleteSpendingItemSuccess = createAction('[Spending] Delete Spending Item Success');
...
export const editSpendingItemSuccess = createAction('[Spending] Edit Spending Item Success');
